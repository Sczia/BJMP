<div class="modal fade" id="download{{ $record->id }}" tabindex="-1" role="dialog" aria-labelledby="examplModallongTitle"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex justify-content-center">
                    <a href="{{ route('medical.create') }}" class="btn btn-primary mr-3">
                        <span class="d-flex align-items-center"><i class="fa-solid fa-download"></i>&#160;
                            DOWNLOAD</span>
                    </a>
                </div>
